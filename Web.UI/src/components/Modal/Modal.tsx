...
export const Modal = memo((props: ModalProps) => {
  ...
  return createPortal(
    <Backdrop onClick={isBackdropStatic ? undefined : onClose}>
      <div
        className={twMerge(
          "items-centner m-auto flex max-h-[890px] min-h-[300px] max-w-[600px] flex-col justify-center gap-6 rounded-xl border border-dark-blue-100 bg-dark-blue-200 p-6 shadow-[0_13px_18px_0_rgba(0,0,0,0.5)]",
          className,
        )}
