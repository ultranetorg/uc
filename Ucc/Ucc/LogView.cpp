...
CLogView::CLogView(CCore * c, CLog * l, CGdiRect & r, CNativeWindow * mmc, int menuItemID) : CNativeWindow(c, 0, L"", WS_VISIBLE|WS_SYSMENU|WS_THICKFRAME, r.X, r.Y, r.W, r.H, mmc->Hwnd, null, c->LocationInstance, null)
{
	Mmc			= mmc;
