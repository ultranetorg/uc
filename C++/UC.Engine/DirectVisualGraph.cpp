...
CDirectVisualGraph::CDirectVisualGraph(CEngineLevel * l, CDirectPipelineFactory * pf) : CVisualGraph(l, pf)
{
...
CDirectVisualGraph::~CDirectVisualGraph()
{
...
void CDirectVisualGraph::Render(CRenderTarget * t, CViewport * vp, CVisualSpace * s)
{
	auto & nodes = s->Nodes;
...
void CDirectVisualGraph::AssignPipelines(CVisualSpace * space, CRenderTarget * target, CVisual * root, CVisual * v)
{
/*
...
void CDirectVisualGraph::Render(CVisualSpace * s, CRenderTarget * t, CViewport * vp, CCamera * cam, CDirectPipeline * pl, CVisual * root, CVisual * v, int & sref, bool alpha)
{
	if(!v->Spaces.empty() && !v->Spaces.Contains(s))
	{
		return;
	}
...
void CDirectVisualGraph::RenderVisual(CDirectDevice * d, CVisualSpace * s, CVisual * v, CCamera * c, int & sref)
{
	#ifdef _DEBUG
...
void CDirectVisualGraph::RenderClipping(CDirectDevice * d, CVisualSpace * s, CVisual * v, CCamera * c, int & index)
{
