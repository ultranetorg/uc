...
public class BorderTimePicker : TimePicker
{
	...
	public static BindableProperty BorderColorProperty = BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(BorderTimePicker), Colors.Transparent);
	...
	public static BindableProperty FillColorProperty = BindableProperty.Create(nameof(FillColor), typeof(Color), typeof(BorderTimePicker), Colors.Transparent);
	...
	public static readonly BindableProperty LineColorProperty =
		BindableProperty.Create(nameof(LineColor), typeof(Color), typeof(BorderTimePicker), Colors.Transparent);
