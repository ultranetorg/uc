...
public class TextResources
{
	...
	public const string DELETEACCOUNT_WARNING1 = "This account has non zero balance. Do you wish to delete it?";
	public const string DELETEACCOUNT_WARNING2 = "If you have not backuped it or not exported, all moneys, domains and programs will be lost";
}
