...
public partial class App : Application
{
	...
	private static void InitializeRouting()
	{
		...
		Routing.RegisterRoute(Routes.AUTHOR_DETAILS, typeof(DomainDetailsPage));
		Routing.RegisterRoute(Routes.AUTHOR_REGISTRATION, typeof(DomainRegistrationPage));
		Routing.RegisterRoute(Routes.AUTHOR_RENEWAL, typeof(DomainRenewalPage));
		Routing.RegisterRoute(Routes.AUTHOR_TRANSFER, typeof(DomainTransferPage));
		Routing.RegisterRoute(Routes.PRODUCT_REGISTRATION, typeof(ResourceRegistrationPage));
		Routing.RegisterRoute(Routes.PRODUCT_TRANSFER, typeof(ResourceTransferPage));
		Routing.RegisterRoute(Routes.MAKE_BID, typeof(MakeBidPage));
		Routing.RegisterRoute(Routes.PRODUCT_SEARCH, typeof(ResourcesSearchPage));
