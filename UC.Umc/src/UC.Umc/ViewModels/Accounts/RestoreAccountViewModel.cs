...
public partial class RestoreAccountViewModel
(
	ILogger<RestoreAccountViewModel> logger,
	string privateKey,
	string walletFilePath,
	string walletFilePassword,
	string accountName
) : BaseAccountViewModel(logger)
{
	...
	[ObservableProperty]
	private string _privateKey = privateKey;

	[ObservableProperty]
	private string _walletFilePath = walletFilePath;

	[ObservableProperty]
	private string _walletFilePassword = walletFilePassword;
