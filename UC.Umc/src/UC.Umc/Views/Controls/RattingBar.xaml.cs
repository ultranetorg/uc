...
public partial class RattingBar : ContentView
{
	...
	// (TBR) this property is private because I don't wanna access it globally
	...
	{
		get => (ImageSource) GetValue(FillStarImageProperty);
	...
	{
		get => (int) GetValue(SelectedStarValueProperty);
