...
public class NnRequestPacket: Packet
{
...
public class NnPeer : IBinarySerializable
{
	...
	public NnTcpPeering			Peering;
	TcpClient					Tcp;
	NetworkStream				Stream;
	BinaryWriter				Writer;
	BinaryReader				Reader;
	Thread						ListenThread;
	List<NnRequestPacket>		OutRequests = new();
	...
	public static bool operator == (NnPeer a, NnPeer b)
	{
	...
	{
		return o is NnPeer a && Equals(a);  
	}

	public bool Equals(NnPeer a)
	{
	...
	public void Start(NnTcpPeering peering, TcpClient client, Hello h, bool inbound)
	{
		Peering = peering;
		Tcp = client;
