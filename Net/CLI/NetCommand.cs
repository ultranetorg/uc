...
public abstract class NetCommand : Command
{
	...
	public static readonly ArgumentType		NAME		= new (nameof(NAME),		$"An single-line string of [a-z 0-9 _] symbols from {User.NameLengthMin} to {User.NemaLengthMax} length",		
