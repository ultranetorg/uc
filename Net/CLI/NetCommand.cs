...
{
	public static readonly ArgumentType		AA			= new ("AA",			@"Account address, in Bech32 form",										["plsar7tfrq83mvfaw0m6u0l9jmsxhkjvk5zzanaqrhavfygl5w2sq3cyyk9btes", "gya27t2jsxdfa3gdywck9cdtwe6lhc59qwwrq2jdq6plz3k9hhjsqx0yuc6btes", "uh39t57ujhn4skcdhkg24mavdp4jsghtvv0uxeg2596et7h6vmnsqrntezqbtes", "vlrvxjhwz96gckyk9etxft3980agmy8s38u45gscp93ajk8rje5qqkgeww3btes"]);
	public static readonly ArgumentType		COMMAND		= new ("COMMAND",		@"CLI command string",													["node peers"]);
	public static readonly ArgumentType		OPEARATION	= new ("OPEARATION",	@"MCV operation",														["{utility transfer from=user/12390-0 to=user/12345-6 e=100}"]);
	public static readonly ArgumentType		IP			= new ("IP",			@"IP Address",															["123.234.55.66"]);
	public static readonly ArgumentType		INT			= new ("INT",			@"Positive integer number",												["324552", "1000"]);
	public static readonly ArgumentType		HEX			= new ("HEX",			@"Array of bytes in form of hexadecimal string",						["0105BCE1C336874FBEBE40D2510EC035D0251FE855399EAD76E22BD18E2EBC6E37"]);
	public static readonly ArgumentType		HOST		= new ("HOST",			@"Host name",															["1.2.3.4"]);
	...
	public static readonly ArgumentType		NA			= new ("NA",			@"A name of a network",													["rdn", "fair"]);
	public static readonly ArgumentType		NN			= new ("NN",			@"Full address of a network",											["fair.rdn"]);
	public static readonly ArgumentType		ST			= new ("ST",			@"Space-time in form of byte-years(BY), byte-days(BD), eth.",			["300bd", "500by"]);
	public static readonly ArgumentType		EC			= new ("EC",			@"Execution Cycles in form of integer number",							["1000", "10"]);
	public static readonly ArgumentType		TEXT		= new ("TEXT",			@"Arbitrary text, can be multi-line",									["\"Hello world!\"", "\"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua\"", "\"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur\""]);
	public static readonly ArgumentType		UID			= new ("UID",			@"User Id",																["123456-789"]);
	public static readonly ArgumentType		SNQ			= new ("SNQ",			@"URI-derived scheme-network-query address",							[new Snq(Iccp.Scheme, "fair", "author/123-234")]);
	public static readonly ArgumentType		URI			= new ("URI",			@"Fully-qualified URI address",											["http://fair.net", "iccp:fair/author"]);
	public static readonly ArgumentType		URL			= new ("URL",			@"Fully-qualified URL address",											["http://fair.net", "http://ultranet.org"]);
