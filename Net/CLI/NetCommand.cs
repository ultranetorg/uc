...
public abstract class NetCommand : Command
{
	...
	public static readonly ArgumentType		COMMAND		= new ("COMMAND",		@"Arbitrary command",													["{...}"]);
	public static readonly ArgumentType		IP			= new ("IP",			@"IP Address",															["12.34.56.78"]);
	...
	public static readonly ArgumentType		NAME		= new ("NAME",			@"An arbitrary single-line string without spaces",						["one", "second"]);
	public static readonly ArgumentType		NET			= new ("NET",			@"A name of a network",													["rdn"]);
	...
	public static readonly ArgumentType		SNP			= new ("SNP",			@"Universal scheme-network-path address",								["iccp:fair/author/123-234"]);
