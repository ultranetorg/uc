...
namespace Uccs.Net
{
	...
	public class FileDownload
	{
		...
		public FileDownload(Rdn sun, LocalRelease release, string path, string localpath, IIntegrity integrity, Harvester seedcollector, Flow flow)
		{
			Rdn				= sun;
			Release			= release;
	...
	public class DirectoryDownload
	{
		...
		public DirectoryDownload(Rdn sun, LocalRelease release, string localpath, IIntegrity integrity, Flow workflow)
		{
			Release = release;
			LocalPath = localpath;
			Release.Activity = this;
