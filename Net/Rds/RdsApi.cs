...
namespace Uccs.Net
{
	public abstract class RdsApc : McvApc
	{
		public abstract object Execute(Rds sun, HttpListenerRequest request, HttpListenerResponse response, Flow workflow);

		public override object Execute(Mcv mcv, HttpListenerRequest request, HttpListenerResponse response, Flow workflow)
		{
			return Execute(mcv as Rds, request, response, workflow);
		}
	}

	public class GetApc : RdsApc
	{
	...
	public class EstimateEmitApc : RdsApc
	{
	...
	public class EmissionApc : RdsApc
	{
