...
public class AuthorCommand : FairCommand
{
	...
	public CommandAction Name_N()
	{
		...
		a.Arguments =  [
							NameOrIdOf("author to set name for"),
	...
	public CommandAction Security_S()
	{
		...
		a.Arguments =	[
							NameOrIdOf("author whose owner list will be modified"),
	...
	public CommandAction Renew_R()
	{
		...
		a.Arguments =  [NameOrIdOf("author to update"),
	...
	public CommandAction Avatar()
	{
		...
		a.Arguments =	[
							NameOrIdOf("author to change avatar of"),
	...
	public CommandAction Entity_E()
	{
		...
		a.Arguments =	[NameOrIdOf("author to get information about")];
