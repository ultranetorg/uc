...
export type CustomSelectProps<IsMulti extends boolean> = Props<DropdownSearchAccountsItem, IsMulti>

export const CustomSelect = <IsMulti extends boolean>(props: CustomSelectProps<IsMulti>) => <Select {...props} />

export const Control = ({ children, ...props }: ControlProps<DropdownSearchAccountsItem, false>) => (
  <components.Control {...props}>
    <SvgSearchSm className="stroke-gray-500" /> {children}
  </components.Control>
)

export const IndicatorsContainer = (props: IndicatorsContainerProps<DropdownSearchAccountsItem, false>) => (
  <components.IndicatorsContainer {...props}>
    {props.selectProps.inputValue && (
      <div
        ...
        onMouseDown={e => {
          e.preventDefault()
          props.selectProps.onInputChange("", { action: "input-change", prevInputValue: props.selectProps.inputValue })
        }}
      >
...
export const Option = (props: OptionProps<DropdownSearchAccountsItem, false>) => (
  <components.Option {...props}>
    <div className="flex items-center gap-2">
      <div className="size-8 overflow-hidden rounded-full">
        <img
          className="size-full object-cover object-center"
          src={buildUserAvatarByIdUrl(props.data.avatarId)}
          loading="lazy"
          onError={e => {
