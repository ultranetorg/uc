...
export const ButtonOutline = ({ className, label, onClick }: ButtonOutlineProps) => (
  <span
    className={twMerge(
      "transition-base flex w-fit cursor-pointer items-center justify-center rounded border border-gray-400 px-4 py-2 text-2sm leading-5 text-gray-800 hover:border-gray-950",
      className,
    )}
    onClick={onClick}
  >
