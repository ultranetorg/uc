...
import { SvgChevronRight, SvgPerson2, SvgPersonSquare } from "assets"
  ...
  forwardRef<HTMLDivElement, ProfilePanelProps>(
    ({ customParentId, hasAvatar, style, selectedUserName, address, ...userSwitcherProps }, ref) => {
      ...
      return (
        <>
          <div
            className="z-10 flex w-[340px] flex-col gap-2 overflow-hidden rounded-lg bg-gray-800 p-2 text-white shadow-md"
            ref={ref}
            style={style}
          >
