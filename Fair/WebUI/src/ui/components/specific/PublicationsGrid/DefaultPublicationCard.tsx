...
export const DefaultPublicationCard = ({ id, title, logoFileId, authorTitle, categoryTitle }: PublicationCardProps) => (
  <div
  ...
  >
    <div className="size-14 overflow-hidden rounded-lg">
      <ImageFallback src={buildFileUrl(logoFileId)} fallback={<SvgSoftwareLogo className="size-full object-cover" />} />
    </div>
