...
import { Button, ButtonOutline } from "ui/components"
...
export const ReviewsList = memo(
  ({ isPending, reviews, error, noReviewsLabel, showMoreReviewsLabel, reviewLabel }: ReviewsListProps) => (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <ButtonOutline label="Leave a Review" />
      </div>
      {error ? (
