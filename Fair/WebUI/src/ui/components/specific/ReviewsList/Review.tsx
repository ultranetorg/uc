...
export const Review = ({ text, accountName, accountImage, rating, created }: ReviewProps) => {
  return (
      ...
      <div className="flex flex-col gap-4">
        <div className="flex gap-4.5">
          <div className="h-13 w-13 overflow-hidden rounded-full">
            <img src={buildSrc(accountImage, TEST_REVIEW_SRC)} className="h-full w-full object-cover" />
          </div>
          <div className="flex flex-col justify-center gap-2">
            <span className="text-2sm font-semibold leading-4.5 text-gray-800">{accountName}</span>
