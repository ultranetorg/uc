	...
	return (
		<div className="flex max-w-[750px] flex-col gap-3">
			<div className="relative h-[416px] overflow-hidden rounded-lg bg-white">
				...
				<div className="swiper-button-prev absolute left-2 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full px-3 hover:bg-black/10">
					<SvgChevronLeftMd className="stroke-white" />
				</div>
				<div className="swiper-button-next absolute right-2 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full px-3 hover:bg-black/10">
				...
				<div className="flex gap-2 overflow-auto pb-1">
					{thumbs.map((t, idx) => (
						<button
								...
								className={
									idx === activeIndex
										? "h-14 w-22 shrink-0 overflow-hidden rounded-md outline-none focus:outline-none focus-visible:outline-none"
										: "h-14 w-22 shrink-0 overflow-hidden rounded-md opacity-60 hover:opacity-100 outline-none focus:outline-none focus-visible:outline-none"
								}
							>
