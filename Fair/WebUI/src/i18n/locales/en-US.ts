export const enUS = {
  ...
  installModal: {
    ...
    userText:
      "<span>This is decentralized autonomous owner-free platform and requires Client Software installed to participate in its communities.</span><span>Windows OS is currently supported only.</span><span>Please, follow the link below to install.</span>",
