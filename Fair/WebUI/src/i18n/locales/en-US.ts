export const enUS = {
  ...
  toast: {
    ...
    proposalExecuted: `Operation "{{operation}}" successfully executed`,
  ...
  profile: {
    ...
    totalPublications: "Total publications in all stores",
    title: "Title",
  ...
  publicationPage: {
    ...
    countries: "Countries",
    director: "Director",
    downloadFromIpfs: "IPFS Download",
    downloadFromRdn: "Rdn Download",
    downloadFromTorrent: "Magnet Download",
    downloadFromWeb: "Web Download",
    eula: "EULA",
    genre: "Genre",
  ...
  proposalView: {
    ...
    "store-moderator-addition_one": "Add this moderator",
    "store-moderator-addition_other": "Add this moderators",
    "store-moderator-removal": "Remove this moderator",
  },
  createProposal: {
  ...
  signInModal: {
    alreadyHaveAccount: "Already have a user?",
    authenticationCancelled: "Authentication cancelled",
    crateNewFairUser: "Create a new Fair user",
    dontHaveAccount: "Don’t have a user?",
  ...
  operations: {
    ...
    "store-authors-removal": "Remove store authors",
    "store-avatar-change": "Change store avatar",
  ...
  operationsShort: {
    ...
    "review-creation": "New",
    "review-edit": "Edit",
    "store-authors-removal": "Remove",
    "store-moderator-addition": "Add",
    "store-moderator-removal": "Remove",
  },
  platforms: {
    linux: "Linux",
    macos: "macOS",
  ...
  validation: {
    ...
    nicknameAvailable: "Username is available",
    ...
    uniqueStoreNickname: "Store nickname must be unique",
