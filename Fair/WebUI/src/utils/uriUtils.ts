export const isWebUri = (value?: string) => value && (value.startsWith("http://") || value.startsWith("https://"))

export const isMagnetUri = (value?: string) => value && value.startsWith("magnet:?")

export const isIpfsUri = (value?: string) => value && value.startsWith("ipfs://")

export const isRdnLink = (value?: string) => value && value.startsWith("iccp:")
